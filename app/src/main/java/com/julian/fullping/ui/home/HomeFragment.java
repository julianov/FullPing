...
public class HomeFragment extends Fragment {
    ...
    //runs without a timer by reposting this handler at th
    // e end of the runnable
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        btn = (Button) root.findViewById(R.id.ejecutar);
        ...
        gethost=(EditText) root.findViewById(R.id.domain);
        host=null;
